...
void EmptyLinkFunctionForGeneratedCodeMysteryMansionCharacter() {}
...
MYSTERYMANSION_API UClass* Z_Construct_UClass_AMysteryMansionCharacter_NoRegister();
UPackage* Z_Construct_UPackage__Script_MysteryMansion();
// End Cross Module References

// Begin Class AMysteryMansionCharacter
void AMysteryMansionCharacter::StaticRegisterNativesAMysteryMansionCharacter()
{
}
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(AMysteryMansionCharacter);
UClass* Z_Construct_UClass_AMysteryMansionCharacter_NoRegister()
{
	return AMysteryMansionCharacter::StaticClass();
}
struct Z_Construct_UClass_AMysteryMansionCharacter_Statics
{
#if WITH_METADATA
	...
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AMysteryMansionCharacter>::IsAbstract,
	};
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMysteryMansionCharacter_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_AMysteryMansionCharacter_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_ACharacter,
	(UObject* (*)())Z_Construct_UPackage__Script_MysteryMansion,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMysteryMansionCharacter_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_AMysteryMansionCharacter_Statics::ClassParams = {
	&AMysteryMansionCharacter::StaticClass,
	"Game",
	&StaticCppClassTypeInfo,
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_AMysteryMansionCharacter_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_AMysteryMansionCharacter_Statics::PropPointers),
	0,
	0x008000A4u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMysteryMansionCharacter_Statics::Class_MetaDataParams), Z_Construct_UClass_AMysteryMansionCharacter_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_AMysteryMansionCharacter()
{
	if (!Z_Registration_Info_UClass_AMysteryMansionCharacter.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_AMysteryMansionCharacter.OuterSingleton, Z_Construct_UClass_AMysteryMansionCharacter_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_AMysteryMansionCharacter.OuterSingleton;
}
template<> MYSTERYMANSION_API UClass* StaticClass<AMysteryMansionCharacter>()
{
	return AMysteryMansionCharacter::StaticClass();
}
DEFINE_VTABLE_PTR_HELPER_CTOR(AMysteryMansionCharacter);
AMysteryMansionCharacter::~AMysteryMansionCharacter() {}
// End Class AMysteryMansionCharacter
